(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@babel/runtime/regenerator'), require('@babel/runtime/helpers/asyncToGenerator'), require('@babel/runtime/helpers/classCallCheck'), require('@babel/runtime/helpers/createClass'), require('@babel/runtime/helpers/slicedToArray'), require('@babel/runtime/helpers/toConsumableArray'), require('@babel/runtime/helpers/defineProperty'), require('@babel/runtime/helpers/possibleConstructorReturn'), require('@babel/runtime/helpers/getPrototypeOf'), require('@babel/runtime/helpers/inherits'), require('react'), require('@babel/runtime/helpers/get')) :
  typeof define === 'function' && define.amd ? define(['exports', '@babel/runtime/regenerator', '@babel/runtime/helpers/asyncToGenerator', '@babel/runtime/helpers/classCallCheck', '@babel/runtime/helpers/createClass', '@babel/runtime/helpers/slicedToArray', '@babel/runtime/helpers/toConsumableArray', '@babel/runtime/helpers/defineProperty', '@babel/runtime/helpers/possibleConstructorReturn', '@babel/runtime/helpers/getPrototypeOf', '@babel/runtime/helpers/inherits', 'react', '@babel/runtime/helpers/get'], factory) :
  (global = global || self, factory(global.markGor = {}, global._regeneratorRuntime, global._asyncToGenerator, global._classCallCheck, global._createClass, global._slicedToArray, global._toConsumableArray, global._defineProperty, global._possibleConstructorReturn, global._getPrototypeOf, global._inherits, global.React, global._get));
}(this, (function (exports, _regeneratorRuntime, _asyncToGenerator, _classCallCheck, _createClass, _slicedToArray, _toConsumableArray, _defineProperty, _possibleConstructorReturn, _getPrototypeOf, _inherits, React, _get) { 'use strict';
    ...
    if (options && options.highlight) {
      ...
      try {
        for (var _iterator = findCodeSections(tokens)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          var token = _step.value;
          var highlighted = options.highlight(token.text, token.lang);

          if (typeof highlighted === 'string') {
            highlighted = parse(highlighted, {
              htmlOnly: true
            });
          }
  ...
  function _parseAsync() {
    ...
    _regeneratorRuntime.mark(function _callee(text, options) {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              renderer = new ReactRenderer(options);
              _context.next = 4;
      ...
      }, _callee, null, [[9, 28, 32, 40], [33,, 35, 39]]);
    }));
    return _parseAsync.apply(this, arguments);
  }
